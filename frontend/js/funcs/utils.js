...
const searchInArray = (array, searchProperty, searchValid) => {
    // console.log(array, searchProperty, searchValid)
    return array.filter(item => item[searchProperty].includes(searchValid));
//     phpstorm dry
}
...
export {
    showSwal, saveIntoLocalstorage, getFromLocalstorage, getToken,
    isLogin, getUrlParam, searchInArray, addParamToUrl, paginateItems
}